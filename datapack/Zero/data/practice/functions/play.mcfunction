...
# zdash telemetry: tower/type at run start (even if run fails)
tellraw @a [{"text":"[ZDASH] Tower: "},{"nbt":"active","storage":"practice:towers","color":"gray"}]
execute if score location_act settings matches 0 if score direction_act settings matches 0 if score rotation_act settings matches 0 run tellraw @a [{"text":"[ZDASH] Type: Front Diagonal CW","color":"gray"}]
execute if score location_act settings matches 1 if score direction_act settings matches 0 if score rotation_act settings matches 0 run tellraw @a [{"text":"[ZDASH] Type: Back Diagonal CW","color":"gray"}]
execute if score location_act settings matches 0 if score direction_act settings matches 1 if score rotation_act settings matches 0 run tellraw @a [{"text":"[ZDASH] Type: Front Straight CW","color":"gray"}]
execute if score location_act settings matches 1 if score direction_act settings matches 1 if score rotation_act settings matches 0 run tellraw @a [{"text":"[ZDASH] Type: Back Straight CW","color":"gray"}]
execute if score location_act settings matches 0 if score direction_act settings matches 0 if score rotation_act settings matches 1 run tellraw @a [{"text":"[ZDASH] Type: Front Diagonal CCW","color":"gray"}]
execute if score location_act settings matches 1 if score direction_act settings matches 0 if score rotation_act settings matches 1 run tellraw @a [{"text":"[ZDASH] Type: Back Diagonal CCW","color":"gray"}]
execute if score location_act settings matches 0 if score direction_act settings matches 1 if score rotation_act settings matches 1 run tellraw @a [{"text":"[ZDASH] Type: Front Straight CCW","color":"gray"}]
execute if score location_act settings matches 1 if score direction_act settings matches 1 if score rotation_act settings matches 1 run tellraw @a [{"text":"[ZDASH] Type: Back Straight CCW","color":"gray"}]
