...
scoreboard players set tower settings 3
...
data modify storage practice:zdash target_name set value "M-85"
tellraw @a [{"text":"[ZDASH] Target set: M-85 | Front | Diagonal CCW","color":"gray"}]
