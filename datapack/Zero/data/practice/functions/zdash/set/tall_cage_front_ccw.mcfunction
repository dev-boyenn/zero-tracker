...
scoreboard players set tower settings 2
...
data modify storage practice:zdash target_name set value "Tall Cage"
tellraw @a [{"text":"[ZDASH] Target set: Tall Cage | Front | Diagonal CCW","color":"gray"}]
