...
scoreboard players set tower settings 9
...
data modify storage practice:zdash target_name set value "Tall Boy"
tellraw @a [{"text":"[ZDASH] Target set: Tall Boy | Front | Diagonal CCW","color":"gray"}]
