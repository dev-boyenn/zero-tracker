...
scoreboard players set tower settings 5
...
data modify storage practice:zdash target_name set value "M-91"
tellraw @a [{"text":"[ZDASH] Target set: M-91 | Front | Diagonal CCW","color":"gray"}]
